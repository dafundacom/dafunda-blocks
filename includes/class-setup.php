...
final class Setup
{
    ...
    public function enqueue_dafunda_block_asset()
    {
        add_action(
            ...
            function () {
                ...
                wp_register_style(
                    ...
                    filemtime(plugins_url("build/blocks/$prefix.blocks.editor.build.css", dirname(__FILE__)))
                );
            }
        );
        ...
        add_action(
            ...
            function () {
            $prefix = DBE_PREFIX;
            wp_enqueue_style('dbe-block-style-front', plugins_url("/build/blocks/$prefix.blocks.frontend.build.css", dirname(__FILE__)), [], filemtime(plugins_url("build/blocks/$prefix.blocks.editor.build.css", dirname(__FILE__)))
            , 'all');
        }
        );

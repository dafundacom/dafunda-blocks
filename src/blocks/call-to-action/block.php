...
function dbe_render_call_to_action_block($attributes){
    extract($attributes);
    return '<div class="call_to_action' . (isset($className) ? ' ' . esc_attr($className) : '') .
                '"' . ($blockID !== '' ? ' id="call_to_action_' . $blockID . '"' :
                ...
                <div class="call_to_action_headline">
                    <' . ($useHeadingTag ? $selectedHeadingTag : 'p') . ' class="call_to_action_headline_text"' . ($blockID === '' ?
                ...
                <div class="call_to_action_button">
                    <a href="' . esc_url($url) . '" target="_' . ($openInNewTab ? 'blank' : 'self' )
                        ...
                        class="cta_button"' . ($blockID === '' ? ' style="background-color: ' . $buttonColor . '; width: ' . $buttonWidth . 'px;"' : '') . '>
                        <p class="cta_button_text"' . ($blockID === '' ? ' style="color: ' .

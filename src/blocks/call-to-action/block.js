...
let block_name = "dbe/call-to-action-block";
let block_config = dafunda_blocks.filter((con) => con.name == block_name);
if (block_config[0] && block_config[0].active) {
  registerBlockType("dbe/call-to-action", {
    title: __("Call to Action", "dafunda-blocks"),
    icon: icon,
    category: "dafundablocks",
    keywords: [
      __("call to action", "dafunda-blocks"),
      __("conversion", "dafunda-blocks"),
              ...
              replaceBlock(
                ...
                createBlock(
                  ...
                  Object.assign(otherAttributes, {
                    dbe_call_to_action_headline_text: mergeRichTextArray(
                      dbe_call_to_action_headline_text
                    ),
                    dbe_cta_content_text:
                      mergeRichTextArray(dbe_cta_content_text),

                    dbe_cta_button_text:
                      mergeRichTextArray(dbe_cta_button_text),
                    url: url,
                  })
                )
              );
  ...
  registerBlockType("dbe/call-to-action-block", {
    title: __("Call to Action", "dafunda-blocks"),
    icon: icon,
    category: "dafundablocks",
    keywords: [

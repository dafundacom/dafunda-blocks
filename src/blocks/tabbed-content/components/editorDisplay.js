...
export class OldTabHolder extends Component {
  ...
  render() {
    ...
    const addTab = (i) => {
      insertBlock(createBlock("dbe/tab", {}), i, this.props.block.clientId);
      ...
      <div className={className}>
        ...
        <div className={`${className}-holder`}>
          ...
          <div className={`${className}-tabs-content`}>
            <InnerBlocks templateLock={false} allowedBlocks={["dbe/tab"]} />
          </div>
        </div>
      </div>,
    ];
      ...
      >
        ...
        >
          ...
          >
            <InnerBlocks
              templateLock={false}
              allowedBlocks={["dbe/tab-block"]}
              template={[["dbe/tab-block"]]}
            />
          </div>
        </div>
      </div>,

 ...
 * @param  {string}   name     dbe/tabbed-content.
 * @param  {Object}   settings Block settings.
 * @return {?WPBlock}          The block, if it has been successfully
 *                             registered; otherwise `undefined`.
 */

registerBlockType("dbe/tabbed-content", {
	title: __("Tabbed Content"),
	icon: icon,
	category: "dafundablocks",
	keywords: [__("Tabbed Content"), __("Tabs"), __("Dafunda Blocks")],
			...
			migrate: (attributes) => {
				...
				return [
					...
					tabsContent.map((t) => {
						...
						return createBlock("dbe/tab", {}, tabContent);
					}),
				];
			},
			save: version_1_1_2,
...
registerBlockType("dbe/tabbed-content-block", {
	title: __("Tabbed Content"),
	icon: icon,
	category: "dafundablocks",
	keywords: [__("Tabbed Content"), __("Tabs"), __("Dafunda Blocks")],

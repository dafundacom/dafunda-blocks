<div class="dbe-block button-download rounded-lg border border-border border-solid p-3 flex flex-wrap overflow-hidden">
  <div class="basis-2/12">
    <figure class="relative">
      <img class="w-full aspect-square rounded-lg  object-cover object-center"
        src="<?= $imageurl ?>" />
    </figure>
  </div>
  ...
  <a href="<?= $url ?>"
    ...
    class="py-2 px-5 ml-auto w-fit h-fit text-xs md:text-base font-bold
    <?= $downloadButtonClass ?>" style="background-color:

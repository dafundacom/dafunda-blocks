...
export default class Inspector extends Component {
	...
	render() {
		...
		const postTypeOptions = [
			{ value: "grid", label: __("Grid", "dafunda-blocks") },
			{ value: "list", label: __("List", "dafunda-blocks") },
		];
		...
		return (
			<InspectorControls>
				<PanelBody title={__("Post Grid Settings", "dafunda-blocks")}>
					{Array.isArray(posts) && posts.length > 0 && (
						<>
							<SelectControl
								label={__("Grid Type", "dafunda-blocks")}
							...
							{"grid" === postLayout && (
								<RangeControl
									label={__("Columns", "dafunda-blocks")}
									value={columns}
				...
				{Array.isArray(posts) && posts.length > 0 && (
					<PanelBody title={__("Post Grid Content", "dafunda-blocks")}>
						<ToggleControl
							label={__("Display Featured Image", "dafunda-blocks")}
						...
						{checkPostImage && (
							<>
								<TextControl
									label={__("Post Image Width", "dafunda-blocks")}
									type="number"
									min={1}
								...
								/>
								<ToggleControl
									label={__("Preserve Aspect Ratio", "dafunda-blocks")}
								...
								{!preservePostImageAspectRatio && (
									<TextControl
										label={__("Post Image Height", "dafunda-blocks")}
										type="number"
										min={1}
						...
						{checkPostExcerpt && (
							<RangeControl
								label={__("Excerpt Length", "dafunda-blocks")}
								value={excerptLength}
						...
						<ToggleControl
							label={__("Display Continue Reading Link", "dafunda-blocks")}
							checked={checkPostLink}
							onChange={(checkPostLink) => setAttributes({ checkPostLink })}
						/>
						{checkPostLink && (
							<TextControl
								label={__("Customize Continue Reading Text", "dafunda-blocks")}
								type="text"
								value={readMoreText}

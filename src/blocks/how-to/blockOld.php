...
function dbe_render_how_to_block($attributes){
    ...
    return '<div class="dbe_howto" id="dbe_howto_' . $blockID . '"><' . $firstLevelTag . ' class="howto__title">'
                . $title . '</' . $firstLevelTag . '>' . dbe_convert_to_paragraphs($introduction) . $header . 
...
function dbe_register_how_to_block(){
    if ( function_exists( 'register_block_type' ) ) {
        ...
        register_block_type('dbe/how-to', array(

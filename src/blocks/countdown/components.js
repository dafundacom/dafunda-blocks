...
class Timer extends Component {
	...
	render() {
		...
		const defaultFormat = (
			<p>
				{[
					`${weeks} ${__("weeks", "dafunda-blocks")}`,
					`${days} ${__("days", "dafunda-blocks")}`,
					`${hours} ${__("hours", "dafunda-blocks")}`,
					`${minutes} ${__("minutes", "dafunda-blocks")}`,
					`${seconds} ${__("seconds", "dafunda-blocks")}`,
				]
					.slice(

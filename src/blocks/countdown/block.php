...
function dbe_render_countdown_block($attributes){
    ...
    $circularFormatValues = [dbe_generateCircle("week", $weeks, 52, $circleColor, $circleSize),
    ...
    $circularFormatLabels =  [ '<p>'.__( 'Weeks', 'dafunda-blocks' ).'</p>',
...
function dbe_register_countdown_block() {
	if( function_exists( 'register_block_type' ) ) {
		...
		register_block_type( 'dbe/countdown', array(

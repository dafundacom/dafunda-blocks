...
const AdvancedHeadingEdit = ({
  ...
  return (
    <>
      <InspectorControls>
        <PanelBody
          title={__("Heading Settings", "dafunda-blocks")}
          intialOpen={false}
        >
          {/* Heading Level */}
          <p>{__("Heading Level", "dafunda-blocks")}</p>
          <ButtonGroup aria-label={__("Heading Level", "dafunda-blocks")}>
          ...
          {/* Alignment */}
          <p>{__("Heading Alignment", "dafunda-blocks")}</p>
          <AlignmentToolbar
            value={alignment}
          ...
          <PanelColorSettings
            title={__("Colors", "dafunda-blocks")}
            colorSettings={[
              {
                value: textColor,
                onChange: (textColor) => setAttributes({ textColor }),
                label: __("Heading Text Color", "dafunda-blocks"),
              },
              {
                value: backgroundColor,
                onChange: (backgroundColor) =>
                  setAttributes({ backgroundColor }),
                label: __("Heading Background Color", "dafunda-blocks"),
              },
            ]}
          />
          {/* Font Size */}
        ...
        <PanelBody
          title={__("Typography Settings", "dafunda-blocks")}
          intialOpen={false}
        >
          {/* Text Transform */}
          <SelectControl
            label={__("Text Transform", "dafunda-blocks")}
          ...
          {/* Font Family */}
          <SelectControl
            label={__("Font Family", "dafunda-blocks")}
          ...
          {/* Letter Spacing */}
          <RangeControl
            label={__("Letter Spacing", "dafunda-blocks")}
            value={letterSpacing}
          ...
          {/* Font Weight */}
          <SelectControl
            label={__("Font Weight", "dafunda-blocks")}
          ...
          {/* Line Height */}
          <RangeControl
            label={__("Line Height", "dafunda-blocks")}
            value={lineHeight}

...
class Dropdown extends Component {
	...
	render() {
		...
		const { buttonColor, buttonTextColor, availableFilters, selectedFilters } =
			attributes;
...
registerBlockType("dbe/content-filter-entry", {
	title: __("Content Filter Entry"),
	parent: __("dbe/content-filter"),
	icon: icon,
		...
		return (
			<div className="dbe-content-filter-panel">
				...
				<div className="dbe-content-assigned-filter-tag-area">
					...
					<Dropdown attributes={attributes} setAttributes={setAttributes} />
				</div>
			</div>
		);
	},
...
registerBlockType("dbe/content-filter-entry-block", {
	title: __("Content Filter Entry"),
	parent: __("dbe/content-filter-block"),
	icon: icon,
	category: "dafundablocks",
	attributes: {
		availableFilters: {

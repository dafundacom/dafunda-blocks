...
function dbe_hashHeaderScroll() {
	var scrollType =
		arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "auto";
	var target =
...
document.addEventListener("DOMContentLoaded", function () {
	...
	instances.forEach(function (instance) {
		...
		var tocExtraContainer = block.querySelector(
		...
		instance.addEventListener("click", function (event) {
			...
			if (block.classList.contains("table-of-contents-collapsed")) {
				...
				setTimeout(function () {
					...
					setTimeout(function () {
						...
						setTimeout(function () {
							...
							tocExtraContainer.style.width = "".concat(
								fullWidth - padding,
								"px"
							);
						}, 50);
				...
				setTimeout(function () {
					...
					mainStyle.width = "".concat(
						5 +
							padding +
							instance.closest(".table-of-contents-header-container")
								.scrollWidth,
						"px"
					);
				}, 50);
	...
	if (window.location.hash) {
		...
		setTimeout(function () {
			return dbe_hashHeaderScroll(type, target, offset);
		}, 50);
	}
});

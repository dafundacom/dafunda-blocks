...
function activate_dafunda_blocks() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-dafunda-blocks-activator.php';
...
function deactivate_dafunda_blocks() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-dafunda-blocks-deactivator.php';

<div class="review_block wp-block relative w-full overflow-hidden rounded-md p-4"
  ...
  <div class="absolute inset-0 z-0">
    ...
    <div
      style="background:linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.6477941518404237) 7%, rgba(0,0,0,1) 14%, rgba(0,0,0,1) 100%);transform:scaleY(1.5)"
  ...
  <div class="relative z-10 mb-4 flex w-full flex-row flex-wrap">
    ...
    <div
      class="flex w-full md:w-28 flex-col flex-wrap items-center overflow-hidden rounded-md bg-success/70 order-1 md:order-2 mb-4 md:mb-0"
      ...
      <div class="w-full">
        ...
        <div class="dafunda-block_review-slider mb-6">
          <div class="w-full h-2 rounded bg-white border border-black/20 relative border-solid">
            <div class="bg-danger rounded h-full"
              style="width: <?= $breakdown["value"] ?>%;">
            </div>
            <div
              class="absolute w-4 h-4 bg-white rounded-full border-danger border-solid top-1/2 -translate-x-1/2 -translate-y-1/2"
              style="left: <?= $breakdown["value"] ?>%; border-width: 4px;">
            </div>
          </div>
        </div>
        <?php endforeach?>
